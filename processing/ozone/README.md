...
To follow the example in the [paper](https://doi.org/10.22541/essoar.177170388.88002537/v1) (CESM2-WACCM SSP2-4.5 ensemble 1) start at step 2 with the following data, which can be found [here](https://doi.org/10.5281/zenodo.18436834):
